.PHONY: all lint test test-cov test-docker install dev prep-dev-container clean distclean
...
test-cov: all
	python -m pytest --cov=q2_rgi--junitxml=junit.xml -o junit_family=legacy -n 4 && coverage xml -o coverage.xml
